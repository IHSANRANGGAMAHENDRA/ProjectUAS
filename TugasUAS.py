print("============ Warkop Malabar ============")
nama = input("Nama Kasir: ")

menu = {
    1: {"item": "Ayam Goreng", "harga": 16000},
    2: {"item": "Nasi Rames", "harga": 13000},
    3: {"item": "Mie Ayam", "harga": 10000},
    4: {"item": "Teh Manis", "harga": 5000},
    5: {"item": "Es Campur", "harga": 10000},
    6: {"item": "Es Jeruk", "harga": 7000}
}
...
def main():
    ...
    while True:
        tampilkan_menu()
        try:
            pilihan = int(input("Pilih menu (1-6) atau 0 untuk mengakhiri pesanan: "))
            if pilihan == 0:
                break
            elif pilihan not in menu:
                print("Pilihan tidak valid. Silakan masukkan nomor yang benar bro:)")
            else:
